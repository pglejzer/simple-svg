 ...
 * @param {Boolean} isMouseMove  it's gonna create a line with event listener mousemove, by default is set to false
...
class DrawALine {
  constructor(options = { drawOneLine: false, isMouseMove: true, fillColor: '#fff', strokeColor: '#000' }) {
